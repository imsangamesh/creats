import 'package:creats/core/helpers/my_helper.dart';
...
class MyThemes {
  ...
  static final lightTheme = ThemeData(
    ...
    textTheme: MyHelper.lightTextTheme,
  );
  ...
  static final darkTheme = ThemeData(
    ...
    inputDecorationTheme: const InputDecorationTheme(
      ...
      activeIndicatorBorder: BorderSide(color: Colors.purple, width: 2),
    ),
    textTheme: MyHelper.darkTextTheme,
  );
}
